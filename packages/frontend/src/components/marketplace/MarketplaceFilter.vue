    ...
    <div>
      ...
      <main class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative z-10 flex items-baseline justify-between pt-8 pb-6 border-b border-gray-200">
          <h1 class="text-4xl font-extrabold tracking-tight text-gray-900">New NFT Listings</h1>
...
const filters = [
  {
    ...
    name: "Bet Side",
    options: [
      { value: "0", label: "Back", checked: false },
      { value: "1", label: "Lay", checked: false },
    ],
  },
  {
    id: "bet-type",
    name: "Bet Type",
    options: [{ value: "0", label: "Match Winner", checked: false }],
  },
];
