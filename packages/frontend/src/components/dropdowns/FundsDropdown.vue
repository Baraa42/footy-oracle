    ...
    <div>
      ...
      >
        <div class="flex flex-col text-right">
          ...
          <span class="text-xs leading-relaxed tracking-wide">{{ balance.available }} MATIC</span>
        </div>
...
export default defineComponent({
  setup() {
    ...
    return { isAuthenticated, isToggled, toggle, close, onClickAway, balance, tokens, convertCurrency };
  },
  components: {
    Menu,
    MenuButton,
