<template>
  ...
  >
    <div
      ...
      class="z-[100] sticky w-11/12 sm:w-1/2 md:w-2/5 mx-auto text-gray-100 px-3 py-3 sm:px-6 sm:py-4 border-0 rounded-sm bottom-18 sm:bottom-5 shadow flex justify-between items-center"
    >
