<template>
  ...
  >
    <div
      ...
      class="z-[100] text-gray-100 px-3 py-3 sm:px-6 sm:py-4 border-0 rounded-sm bottom-18 sm:bottom-5 sticky ml-auto mr-auto left-0 right-0 w-11/12 sm:w-5/12 shadow flex justify-between items-center"
    >
