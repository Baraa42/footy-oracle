<template>
  <section class="py-8 px-4 text-center lg:pt-20">
    <div class="max-w-auto mx-auto">
      <div class="md:max-w-lg mx-auto px-4 lg:px-0">
      ...
      <h2 class="mt-12 uppercase text-xl lg:text-5xl font-black">We are sorry, Page not found!</h2>
      <a href="/" class="mt-6 bg-gray-500 hover:bg-gray-700 text-white font-light py-4 px-6 rounded-md inline-block uppercase shadow-md">Go back</a>
    </div>
  </section>
</template>
