    ...
    <div class="flex flex-row w-full space-x-8">
      ...
      <div class="w-1/2 flex flex-col space-y-3">
        <div class="w-full">
          ...
          <select v-model="eventModel" class="mt-1 focus:ring-gray-300 focus:border-gray-300 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            <option v-for="event in events" :value="event">{{ event.get("home") }} vs. {{ event.get("away") }}</option>
          </select>
        </div>
      ...
      <div class="w-1/2 flex flex-col space-y-3">
        <div class="w-full">
          ...
          <select v-model="teamModel" class="mt-1 focus:ring-gray-300 focus:border-gray-300 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            <option v-for="team in teams" :value="team">{{ team.get("name") }}</option>
          </select>
        </div>
...
export default defineComponent({
  async setup() {
     ...
     */
    const events: Ref<EventModel[] | undefined> = await getEvents();
    ...
    model.value.event = eventModel.value;
